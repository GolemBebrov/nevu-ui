# This file was generated by stubgen-pyx v0.2.16 from fast/nevucobj/nevucobj.pyx
...
C_CustomFunctions: _TypeAlias = int
call_noarg = ...
...
class NevuCobject:
    ...
    params: list
    _blacklisted_params: list
    _next_frame_functions: list
    node_type: int
    _params_map: dict
    _param_links: dict
    cache: Cache
