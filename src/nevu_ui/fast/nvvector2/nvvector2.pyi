from typing import overload, Any, Sequence, Tuple, Union, TYPE_CHECKING
if TYPE_CHECKING: 
...
class NvVector2:
    ...
    @staticmethod
    def from_xy(x: float | int, y: float | int) -> 'NvVector2': ...
    ...
    def sadd(self, new_vec: 'NvVector2', other: 'NvVector2') -> None: ...
