...
class OverlayManager:
    ...
    def _validate_strict(self, name: Any, strict: bool, function=None):
        if not strict and function:
            function()
        else:
            raise ValueError(f"Element {name} not found and cannot be changed")
    ...
    def remove_element(self, name: Any, strict: bool = False):
        if self.has_element(name):
            ...
            self._validate_strict(name, strict)
    ...
    def change_element(
        ...
        if self.has_element(name):
            ...
            self._validate_strict(
                name,
                strict,
                lambda: self.add_element(name, surface, coordinates, layer),
            )
