...
class NvRenderTexture:
    ...
    def blit_texture(self, texture: Any, dest: Annotations.dest_like, color: Annotations.rgba_color = ...) -> None: ...
    def fast_blit_texture(self, texture: Any, dest: Annotations.dest_like, flip: bool = ..., color: Annotations.rgba_color = ...) -> None: ...
